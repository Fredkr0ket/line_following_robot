...
def turn(action, previous_yaw, encoder_distance_90=100, encoder_distance_180=200):
...
def box_detection(distance_tof):
    if distance_tof <= 30:
        stop()
        magnet_pin.value(1)
